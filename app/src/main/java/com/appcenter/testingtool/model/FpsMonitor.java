...
*/
/**
 * Created by diskzhou on 14-2-10.
 *//*



public class FpsMonitor extends Thread {
    ...
    public FpsMonitor(SurfaceHolder surfaceHolder, MainGamePanel gamePanel) {
        super();
