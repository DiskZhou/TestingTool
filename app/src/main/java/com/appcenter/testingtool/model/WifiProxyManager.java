...
public class WifiProxyManager {
    ...
    private static WifiProxyManager wifiProxyManager=null;
    private  Context context=null;

    private WifiProxyManager(Context context){
        this.context= context;
    }

    public  static WifiProxyManager  Instance(Context context){
        if (null==wifiProxyManager){
            wifiProxyManager = new WifiProxyManager(context);
            return  wifiProxyManager;
        }else {
            return  wifiProxyManager;
        }
    }
